...
| [**`datadog_metrics`**][docs.sinks.datadog_metrics] | [Streams](#streaming) [`metric`][docs.data-model.metric] events to [Datadog][urls.datadog] metrics service using [HTTP API](https://docs.datadoghq.com/api/?lang=bash#metrics). |
